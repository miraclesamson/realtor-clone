    ...
    <main className="max-w-md px-2 mx-auto">
      ...
      <form>
        ...
        <input
          ...
          border border-grey-300 rounded transition  duration-150
          ease-in-out focus:text-grey-700 focus:bg-white focus:border-slate-600 mb-6"
        />
          ...
          <div className="">
            ...
            <div className="flex w-full justify-center items-center space-x-6">
              <input
                ...
                max="4000000000"
                required
                className="w-full px-4 py-2 text-xl text-gray-700 first-letter:bg-white
        ...
        uppercase rounded shadow-md hover:bg-blue-700 transition focus:bg-blue-700 focus:shadow-lg duration-150
